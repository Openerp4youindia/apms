...
class return_serialized_product(osv.osv_memory):

    _name = 'return.serialized.product'
    ...
    _columns = {
            ...
            'serialize_ids1':fields.many2many('product.serialize','return_serialize_rel1','serial_id1','return_id1','Serial No.'),
            'serialize_ids2':fields.many2many('product.serialize','return_serialize_rel2','serial_id2','return_id2','Serial No.'),
            'serialize_ids3':fields.many2many('product.serialize','return_serialize_rel3','serial_id3','return_id3','Serial No.'),
            'serialize_ids4':fields.many2many('product.serialize','return_serialize_rel4','serial_id4','return_id4','Serial No.'),
            'serialize_ids5':fields.many2many('product.serialize','return_serialize_rel5','serial_id5','return_id5','Serial No.'),
            'serialize_ids6':fields.many2many('product.serialize','return_serialize_rel6','serial_id6','return_id6','Serial No.'),
            'serialize_ids7':fields.many2many('product.serialize','return_serialize_rel7','serial_id7','return_id7','Serial No.'),
            'serialize_ids8':fields.many2many('product.serialize','return_serialize_rel8','serial_id8','return_id8','Serial No.'),
            'serialize_ids9':fields.many2many('product.serialize','return_serialize_rel9','serial_id9','return_id9','Serial No.'),
            'serialize_ids10':fields.many2many('product.serialize','return_serialize_rel10','serial_id10','return_id10','Serial No.'),
            'serialize_ids11':fields.many2many('product.serialize','return_serialize_rel11','serial_id11','return_id11','Serial No.'),
            'serialize_ids12':fields.many2many('product.serialize','return_serialize_rel12','serial_id12','return_id12','Serial No.'),
            'serialize_ids13':fields.many2many('product.serialize','return_serialize_rel13','serial_id13','return_id13','Serial No.'),
            'serialize_ids14':fields.many2many('product.serialize','return_serialize_rel14','serial_id14','return_id14','Serial No.'),
            'serialize_ids15':fields.many2many('product.serialize','return_serialize_rel15','serial_id15','return_id15','Serial No.'),
            'serialize_ids16':fields.many2many('product.serialize','return_serialize_rel16','serial_id16','return_id16','Serial No.'),
            'serialize_ids17':fields.many2many('product.serialize','return_serialize_rel17','serial_id17','return_id17','Serial No.'),
            'serialize_ids18':fields.many2many('product.serialize','return_serialize_rel18','serial_id18','return_id18','Serial No.'),
            'serialize_ids19':fields.many2many('product.serialize','return_serialize_rel19','serial_id19','return_id19','Serial No.'),
            'serialize_ids20':fields.many2many('product.serialize','return_serialize_rel20','serial_id20','return_id20','Serial No.'),
    ...
    def view_init(self, cr , uid , fields_list, context=None):
        ...
        for rec in self.pool.get('stock.return.picking').browse(cr, uid, incm_id):
            i = 1
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type=False, context=None, toolbar=False, submenu=False):
        result = super(return_serialized_product, self).fields_view_get(cr, uid, view_id, view_type, context, toolbar, submenu)
        if view_type == 'form':
            incm_id = context.get('active_ids', False)
            ...
            _moves_arch_lst = """
                                <form string="Return Serialize Products" version="7.0">
                               """
            for rec in self.pool.get('stock.return.picking').browse(cr, uid, incm_id):
            ...
            _moves_arch_lst +="""<separator colspan="4"/>
                                   ...
                                   <button name="return_product" icon="gtk-ok" string="Approved2" type="object"/>
                                   </group>
                                </form>
                                """
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        res = super(return_serialized_product, self).default_get(cr, uid, fields, context=context)
        product_line = []
        if incm_id:
            for rec in self.pool.get('stock.return.picking').browse(cr, uid, incm_id):
                i = 1
...
#                            raise osv.except_osv(('Invalid Operation !'),('Serial number '+ line.name +' cannot be returned, please check once again.' ))
        ...
        return self.pool.get('stock.return.picking').create_returns(cr, uid, picking_ids, context=context)
#        return {'type': 'ir.actions.act_window_close'}

    
return_serialized_product()